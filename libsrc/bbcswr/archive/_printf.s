...
;
	...
	.importzp       sp, ptr1, ptr2, ptr3, ptr4, tmp2, tmp1
...
;                                       SP -> Format String / Output descriptor / va_list

; Save the register bank variables into the save area

        pha                             ; Save low byte of __AX__
...
Save:   lda     regbank,y
        ...
        pla                             ; Restore low byte of __AX__
...
;### NEW ###
        lda     ptr4                    ; Preserve the contents of PTR4
        pha
        lda     ptr4+1
        pha
;### NEW ###
...
;### NEW ###
        pla
        sta     ptr4                    ; Restore contents of ptr4 from CPU stack
        pla
        sta     ptr4+1
;### NEW ###
