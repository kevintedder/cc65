...
void service_claim_pws_hazel() {                  // Do nothing, but allows you to do something

#ifdef BBCSWR_DEBUG
	swr_print_str( "service_claim_pws_hazel:Begin" );
	swr_print_newline();
	dbg_print_rom();
#endif
...
#ifdef BBCSWR_DEBUG
	swr_print_str( "service_claim_pws_hazel:End" );
	swr_print_newline();
#endif
