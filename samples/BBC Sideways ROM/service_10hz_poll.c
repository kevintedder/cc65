...
void service_10hz_poll() {                  // Do nothing, but allows you to do something

#ifdef BBCBBCSWR_DEBUG
	swr_print_str( "service_10hz_poll:Begin" );
	swr_print_newline();
	dbg_print_rom();
#endif
...
#ifdef BBCBBCSWR_DEBUG
	swr_print_str( "service_10hz_poll:End" );
	swr_print_newline();
#endif
