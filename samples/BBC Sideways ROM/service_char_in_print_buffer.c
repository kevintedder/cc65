...
void service_char_in_print_buffer() {                  // Do nothing, but allows you to do something

#ifdef SWR_DEBUG
	swr_print_str( "service_char_in_print_buffer:Begin" );
	swr_print_newline();
	dbg_print_rom();
#endif
...
#ifdef SWR_DEBUG
	swr_print_str( "service_char_in_print_buffer:End" );
	swr_print_newline();
#endif
