...
void service_sound_buffer_purged() {                  // Do nothing, but allows you to do something

#ifdef SWR_DEBUG
	swr_print_str( "service_sound_buffer_purged:Begin" );
	swr_print_newline();
	dbg_print_rom();
#endif
...
#ifdef SWR_DEBUG
	swr_print_str( "service_sound_buffer_purged:End" );
	swr_print_newline();
#endif
