...
void service_claim_aws_hazel() {                  // Do nothing, but allows you to do something

#ifdef BBCSWR_DEBUG
	swr_print_str( "service_claim_aws_hazel:Begin" );
	swr_print_newline();
	dbg_print_rom();
#endif
...
#ifdef BBCSWR_DEBUG
	swr_print_str( "service_claim_aws_hazel:End" );
	swr_print_newline();
#endif
